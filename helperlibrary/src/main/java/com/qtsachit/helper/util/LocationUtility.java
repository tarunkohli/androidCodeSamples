...
public final class LocationUtility {
    ...
    /**
     * This method will return the lat/long based on address
     *
    ...
    public static double[] getLocationInfo(String address) {
        ...
        if (DEBUG) {
            LoggerUtility.debug(TAG, "address : " + address);
        }
        ...
        try {
            ...
            if (DEBUG) {
                LoggerUtility.debug(TAG, "location : (" + longitude + "," + latitude + ")");
            }
    ...
    /**
     * This method will return the address based on lat/lon
     *
     * @param latitude
     * @param longitude
     * @return address
    ...
    /**
     * This method will parsed city and country name based on Google API
     *
     * @param jsonObject
     * @return
     */
