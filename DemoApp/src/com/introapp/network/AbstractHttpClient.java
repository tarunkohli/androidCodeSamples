...
public abstract class AbstractHttpClient {
	 ...
	 * {@link HttpClient} instead.
	 */
	protected int connectionTimeout = 120000;// 2000;
	/**
	...
	public HttpResponse post(String path, String contentType, byte[] data,
			Object obj) {
		return execute(new HttpPost(path, null, contentType, data, obj));
	}
	 ...
	 * {@link HttpClient} in order to wrap the exception handling for purposes
	 * of retries, etc.
	 * 
	 * @param httpRequest
